...
import type { CreditNotePrintData, DeliveryNotePrintData, InvoicePrintData, LaufzettelPrintData, OrderConfirmationPrintData, PrintRepository, QuotePrintData } from "../modules/print/print.service.js";

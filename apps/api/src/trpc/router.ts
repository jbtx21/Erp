  ...
  quotes: router({
    ...
    create: roleProcedure("ADMIN", "BUERO")
      .input(z.object({
        ...
        lines: z.array(z.object({ description: z.string().min(1), qty: z.number().int().positive(), unitNetCents: z.number().int().nonnegative(), listNetCents: z.number().int().nonnegative().optional(), rabattPct: z.number().int().min(0).max(100).optional(), taxRatePct: z.number().int().min(0).max(100).optional(), kind: z.enum(["TEXTIL", "VEREDELUNG", "SONSTIGE"]).optional(), articleId: z.string().optional(), variantId: z.string().optional(), isAlternative: z.boolean().optional(), bezugPositionen: z.array(z.number().int().positive()).optional(), dbCents: z.number().int().optional(), lineType: z.enum(["ARTIKEL", "GRUPPE", "ZWISCHENSUMME", "GRUPPENSUMME"]).optional(), placement: z.string().max(120).optional(), positionType: z.string().max(20).optional(), positionSide: z.string().max(20).optional(), positionId: z.string().max(20).optional(), motiv: z.string().max(120).optional(), motivGroesse: z.string().max(60).optional(), farbton: z.string().max(80).optional(), platzierungsdetails: z.string().max(200).optional(), sonstiges: z.string().max(200).optional(), altPreisText: z.string().max(120).optional(), imPdfAusblenden: z.boolean().optional(), veredlerId: z.string().nullable().optional(), lieferdatum: z.string().datetime().nullable().optional() })).min(1),
      }))
      .mutation(async ({ input, ctx }) => {
    ...
    update: roleProcedure(...supplierRoles)
      .input(z.object({
        ...
        lines: z.array(z.object({
          ...
          bezugPositionen: z.array(z.number().int().positive()).optional(),
          lineType: z.enum(["ARTIKEL", "GRUPPE", "ZWISCHENSUMME", "GRUPPENSUMME"]).optional(),
          placement: z.string().max(120).nullable().optional(), positionType: z.string().max(20).nullable().optional(), positionSide: z.string().max(20).nullable().optional(), positionId: z.string().max(20).nullable().optional(), motiv: z.string().max(120).nullable().optional(), motivGroesse: z.string().max(60).nullable().optional(), farbton: z.string().max(80).nullable().optional(), platzierungsdetails: z.string().max(200).nullable().optional(), sonstiges: z.string().max(200).nullable().optional(), 
          altPreisText: z.string().max(120).nullable().optional(),
          imPdfAusblenden: z.boolean().optional(),
          veredlerId: z.string().nullable().optional(),
        })).nullable().optional(),
      }))
      .mutation(async ({ input, ctx }) => {
